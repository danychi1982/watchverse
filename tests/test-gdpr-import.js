...
assert.strictEqual(plan.series[0].addedAt, '2024-01-01T00:00:00.000Z');
...
assert.strictEqual(plan.movies[0].rating, 6);
assert.strictEqual(plan.movies[0].addedAt, '2024-01-01T00:00:00.000Z');
assert.strictEqual(GDPR.legacyVoteCodeToRating('1'), 2);
assert.strictEqual(GDPR.legacyVoteCodeToRating('27'), 4);
assert.strictEqual(GDPR.legacyVoteCodeToRating('28'), 6);
assert.strictEqual(GDPR.legacyVoteCodeToRating('29'), 8);
assert.strictEqual(GDPR.legacyVoteCodeToRating('3'), 10);
