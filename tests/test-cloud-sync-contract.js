...
for (const token of ['remotePath', 'localWins', 'recordConflict', 'cloud_won', 'on_conflict=profile_id,kind,local_id', 'clearProfileData', 'DELETE', 'Impossibile svuotare i dati cloud']) {
