...
assert(css.includes('left:calc(var(--sidebar-current) / 2)'), 'launcher AIvengers centrato nella sidebar');
assert(css.includes('width:62px'), 'launcher AIvengers ingrandito');
