...
if (!app.includes("row.kind==='tv'||row.kind==='movie'") || !app.includes('searchTitleMatchesQuery')) throw new Error('La ricerca non limita i risultati a film e serie pertinenti');
