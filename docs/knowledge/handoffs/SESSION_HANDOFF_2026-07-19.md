...
Per il collaudo locale è disponibile `avvia-chrome-e2e.bat` nella root del progetto. Avvia un profilo browser separato sulla porta CDP `9222`; va eseguito all’inizio di ogni nuova sessione, dopo un riavvio o dopo la chiusura del browser dedicato. Prima di confermare la risoluzione di una issue Jira con verifica browser, Codex deve richiederne l’avvio e completare gli E2E.
