...
async function seedAccount(page) {
  ...
  await page.fill('#setupUsername','mobile');
  await page.fill('#setupEmail','mobile@example.com');
...
(async () => {
  ...
  if (!executablePath) throw new Error('Chrome o Edge non trovato per il test e2e mobile.');
