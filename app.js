...
(() => {
  ...
  function showLoginScreen(message='') {
    ...
    $('#toggleLoginPassword').addEventListener('click',()=>{const input=$('#loginPassword');const button=$('#toggleLoginPassword');const visible=input.type==='text';input.type=visible?'password':'text';button.setAttribute('aria-label',visible?'Mostra password':'Nascondi password');button.title=visible?'Mostra password':'Nascondi password';button.setAttribute('aria-pressed',String(!visible));input.focus();});
