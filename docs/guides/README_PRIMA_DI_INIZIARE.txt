...
ARCHITETTURA DATI
I metadati comuni sono salvati una sola volta nell’archivio locale “catalog” e riutilizzati da tutti i profili. I dati personali restano separati. La descrizione completa è in docs/specifications/architecture/ARCHITETTURA_DATI.md.

PUBBLICAZIONE
Per pubblicare online carica l’intera cartella su un hosting HTTPS come Netlify. La sincronizzazione cloud tramite Supabase richiede la configurazione descritta in Jira/WVERSE e nel contesto storico archiviato in docs/archive/backlog/BACKLOG_CLOUD_2026-07.md.
