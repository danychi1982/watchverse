...
| ADR-027 | 2026-07-26 | Eccezione documentata per verifiche non automatizzabili | Un issue può passare a Review senza uno specifico E2E solo quando il criterio richiede necessariamente azione manuale, dispositivo fisico, credenziali personali o ambiente non disponibile al runner. Il test omesso, la motivazione e le verifiche automatiche superate devono essere dichiarati in chat e nel commento Jira; Done resta subordinato al test manuale. | Attiva |
